...
const QuizTwo = () => {
  ...
  const options: Option[] = [
    { id: 1, text: 'PLEASE', correct: false }, 
    { id: 2, text: 'PLAY', correct: true }, // This option is correct
  ];
    ...
    if (option.correct) {
      ...
      Snackbar.show({
        ...
        action: {
            ...
            textColor: 'green',
            onPress: () => {
              navigation.navigate('Play'); // Navigate to screen 'B'
            },
          },
      });
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <View>
        <Image source={require('../assets/bages/play.jpg')} 
