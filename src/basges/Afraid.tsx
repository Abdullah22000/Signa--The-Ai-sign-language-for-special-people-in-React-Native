...
const Afraid = () => {
  ...
  return (
    <View style={styles.header}>
      ...
      <TouchableOpacity 
      onPress={() => {
        navigation.navigate('QuizFourth')
      }}>
        <Image 
  ...
  return (
    <View style={styles.container}>
      <Header/>
      <View>
        <Image source={require('../assets/bages/afraid.jpg')} 
          style={{height:"54%",width:"100%", marginTop:80, alignSelf:'center'}}            
        />
      </View>

      <View style={styles.touch}>
          <Text style={styles.txt}> AFRAID</Text>
      </View>
