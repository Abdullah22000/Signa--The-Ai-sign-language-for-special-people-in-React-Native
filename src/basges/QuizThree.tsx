...
const QuizThree = () => {
  ...
  const options: Option[] = [
    { id: 1, text: 'BATH', correct: false }, 
    { id: 2, text: 'LOVE YOU', correct: true }, // This option is correct
  ];
    ...
    if (option.correct) {
      ...
      Snackbar.show({
        ...
        action: {
            ...
            textColor: 'green',
            onPress: () => {
              navigation.navigate('Help'); // Navigate to screen 'B'
            },
          },
      });
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <View>
        <Image source={require('../assets/bages/loveyou.jpg')} 
