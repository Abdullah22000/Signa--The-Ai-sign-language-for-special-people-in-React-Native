...
const QuizFourth = () => {
  ...
  const options: Option[] = [
    ...
    { id: 2, text: 'BATH', correct: true }, // This option is correct
  ];
    ...
    if (option.correct) {
      Snackbar.show({
        ...
        action: {
          ...
          textColor: 'green',
          onPress: () => {
            Alert.alert("CONGRATS!! You have completed the quiz!");
      ...
      Snackbar.show({
        ...
        action: {
            ...
            textColor: 'green',
            onPress: () => {
              navigation.navigate('Drink'); // Navigate to screen 'B'
            },
          },
      });
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <View>
        <Image source={require('../assets/bages/bath.jpg')} 
          style={{height:"54%",width:"100%", marginTop:80}}            
        />
      </View>
      <View>
