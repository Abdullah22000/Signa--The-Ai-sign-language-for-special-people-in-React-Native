...
const QuizOne = () => {
  ...
  const options: Option[] = [
    ...
    { id: 2, text: 'WELCOME', correct: true }, // This option is correct
  ];
    ...
    if (option.correct) {
      ...
      Snackbar.show({
        ...
        action: {
            ...
            textColor: 'green',
            onPress: () => {
              navigation.navigate('BasicGesture'); // Navigate to screen 'B'
            },
          },
      });
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <View>
        <Image source={require('../assets/bages/welcome.jpg')} 
          style={{height:"55%",width:"100%", marginTop:80}}            
        />
      </View>
      <View>
